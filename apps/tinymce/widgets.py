...
import studentsgroup.tinymce.settings
...
class TinyMCE(forms.Textarea):
    ...
    def render(self, name, value, attrs=None):
        ...
        mce_config = studentsgroup.tinymce.settings.DEFAULT_CONFIG.copy()
        mce_config.update(get_language_config(self.content_language))
        if studentsgroup.tinymce.settings.USE_FILEBROWSER:
        ...
        if studentsgroup.tinymce.settings.USE_COMPRESSOR:
            compressor_config = {
    ...
    def _media(self):
        if studentsgroup.tinymce.settings.USE_COMPRESSOR:
            ...
            js = [studentsgroup.tinymce.settings.JS_URL]
        if studentsgroup.tinymce.settings.USE_FILEBROWSER:
...
def get_language_config(content_language=None):
    ...
    if studentsgroup.tinymce.settings.USE_SPELLCHECKER:
